...
{
    char padding_0[0x400];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x400
...
class ANavigationData : public AActor
{
    ...
    char padding_1[0x3];                                                              // 0x02AD (size: 0x3)
    float ObservedPathsTickInterval;                                                  // 0x02B0 (size: 0x4)
    uint32 DataVersion;                                                               // 0x02B4 (size: 0x4)
    char padding_2[0xE0];                                                             // 0x02B8 (size: 0xE0)
    TArray<FSupportedAreaData> SupportedAreas;                                        // 0x0398 (size: 0x10)
...
class ANavigationTestingActor : public AActor
{
    ...
    char padding_2[0x3];                                                              // 0x029D (size: 0x3)
    ...
    char padding_3[0x3];                                                              // 0x02A9 (size: 0x3)
    TEnumAsByte<ENavCostDisplay::Type> CostDisplayMode;                               // 0x02AC (size: 0x1)
    char padding_4[0x3];                                                              // 0x02AD (size: 0x3)
...
{
    uint8 bDrawTriangleEdges;                                                         // 0x0400 (size: 0x1)
    uint8 bDrawPolyEdges;                                                             // 0x0400 (size: 0x1)
    uint8 bDrawFilledPolys;                                                           // 0x0400 (size: 0x1)
    uint8 bDrawNavMeshEdges;                                                          // 0x0400 (size: 0x1)
    uint8 bDrawTileBounds;                                                            // 0x0400 (size: 0x1)
    uint8 bDrawPathCollidingGeometry;                                                 // 0x0400 (size: 0x1)
    uint8 bDrawTileLabels;                                                            // 0x0400 (size: 0x1)
    uint8 bDrawPolygonLabels;                                                         // 0x0400 (size: 0x1)
    uint8 bDrawDefaultPolygonCost;                                                    // 0x0401 (size: 0x1)
    uint8 bDrawLabelsOnPathNodes;                                                     // 0x0401 (size: 0x1)
    uint8 bDrawNavLinks;                                                              // 0x0401 (size: 0x1)
    uint8 bDrawFailedNavLinks;                                                        // 0x0401 (size: 0x1)
    uint8 bDrawClusters;                                                              // 0x0401 (size: 0x1)
    uint8 bDrawOctree;                                                                // 0x0401 (size: 0x1)
    uint8 bDrawOctreeDetails;                                                         // 0x0401 (size: 0x1)
    uint8 bDrawMarkedForbiddenPolys;                                                  // 0x0401 (size: 0x1)
    uint8 bDistinctlyDrawTilesBeingBuilt;                                             // 0x0402 (size: 0x1)
    uint8 bDrawNavMesh;                                                               // 0x0402 (size: 0x1)
    char padding_0[0x1];                                                              // 0x0403 (size: 0x1)
    float DrawOffset;                                                                 // 0x0404 (size: 0x4)
    uint8 bFixedTilePoolSize;                                                         // 0x0408 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0409 (size: 0x3)
    int32 TilePoolSize;                                                               // 0x040C (size: 0x4)
    float TileSizeUU;                                                                 // 0x0410 (size: 0x4)
    float CellSize;                                                                   // 0x0414 (size: 0x4)
    float CellHeight;                                                                 // 0x0418 (size: 0x4)
    float AgentRadius;                                                                // 0x041C (size: 0x4)
    float AgentHeight;                                                                // 0x0420 (size: 0x4)
    float AgentMaxHeight;                                                             // 0x0424 (size: 0x4)
    float AgentMaxSlope;                                                              // 0x0428 (size: 0x4)
    float AgentMaxStepHeight;                                                         // 0x042C (size: 0x4)
    float MinRegionArea;                                                              // 0x0430 (size: 0x4)
    float MergeRegionSize;                                                            // 0x0434 (size: 0x4)
    float MaxSimplificationError;                                                     // 0x0438 (size: 0x4)
    int32 MaxSimultaneousTileGenerationJobsCount;                                     // 0x043C (size: 0x4)
    int32 TileNumberHardLimit;                                                        // 0x0440 (size: 0x4)
    int32 PolyRefTileBits;                                                            // 0x0444 (size: 0x4)
    int32 PolyRefNavPolyBits;                                                         // 0x0448 (size: 0x4)
    int32 PolyRefSaltBits;                                                            // 0x044C (size: 0x4)
    FVector NavMeshOriginOffset;                                                      // 0x0450 (size: 0xC)
    float DefaultDrawDistance;                                                        // 0x045C (size: 0x4)
    float DefaultMaxSearchNodes;                                                      // 0x0460 (size: 0x4)
    float DefaultMaxHierarchicalSearchNodes;                                          // 0x0464 (size: 0x4)
    TEnumAsByte<ERecastPartitioning::Type> RegionPartitioning;                        // 0x0468 (size: 0x1)
    TEnumAsByte<ERecastPartitioning::Type> LayerPartitioning;                         // 0x0469 (size: 0x1)
    char padding_2[0x2];                                                              // 0x046A (size: 0x2)
    int32 RegionChunkSplits;                                                          // 0x046C (size: 0x4)
    int32 LayerChunkSplits;                                                           // 0x0470 (size: 0x4)
    uint8 bSortNavigationAreasByCost;                                                 // 0x0474 (size: 0x1)
    uint8 bPerformVoxelFiltering;                                                     // 0x0474 (size: 0x1)
    uint8 bMarkLowHeightAreas;                                                        // 0x0474 (size: 0x1)
    uint8 bFilterLowSpanSequences;                                                    // 0x0474 (size: 0x1)
    uint8 bFilterLowSpanFromTileCache;                                                // 0x0474 (size: 0x1)
    uint8 bDoFullyAsyncNavDataGathering;                                              // 0x0474 (size: 0x1)
    uint8 bUseBetterOffsetsFromCorners;                                               // 0x0474 (size: 0x1)
    uint8 bStoreEmptyTileLayers;                                                      // 0x0474 (size: 0x1)
    uint8 bUseVirtualFilters;                                                         // 0x0475 (size: 0x1)
    uint8 bAllowNavLinkAsPathEnd;                                                     // 0x0475 (size: 0x1)
    uint8 bUseVoxelCache;                                                             // 0x0475 (size: 0x1)
    char padding_3[0x2];                                                              // 0x0476 (size: 0x2)
    float TileSetUpdateInterval;                                                      // 0x0478 (size: 0x4)
    float HeuristicScale;                                                             // 0x047C (size: 0x4)
    float VerticalDeviationFromGroundCompensation;                                    // 0x0480 (size: 0x4)
...
{
    TArray<FNavigationLink> Links;                                                    // 0x0410 (size: 0x10)
...
class UNavLinkCustomComponent : public UNavRelevantComponent
{
    ...
    char padding_0[0x4];                                                              // 0x00EC (size: 0x4)
    ...
    char padding_2[0x3];                                                              // 0x0121 (size: 0x3)
...
class UNavigationSystemV1 : public UNavigationSystemBase
{
    ...
    char padding_3[0x4];                                                              // 0x008C (size: 0x4)
    ...
    char padding_4[0x10];                                                             // 0x00B0 (size: 0x10)
    ...
    void OnNavDataGenericEvent(class ANavigationData* NavData);
    char padding_5[0xDC];                                                             // 0x00E0 (size: 0xDC)
    FNavigationSystemRunMode OperationMode;                                           // 0x01BC (size: 0x1)
    char padding_6[0x357];                                                            // 0x01BD (size: 0x357)
