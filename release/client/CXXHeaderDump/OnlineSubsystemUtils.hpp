...
class APartyBeaconHost : public AOnlineBeaconHostObject
{
    ...
    char padding_0[0x60];                                                             // 0x0250 (size: 0x60)
...
{
    float SocketErrorDisconnectDelay;                                                 // 0x1AD0 (size: 0x4)
...
class UIpNetDriver : public UNetDriver
{
    ...
    char padding_0[0x3];                                                              // 0x0749 (size: 0x3)
    uint32 MaxPortCountToTry;                                                         // 0x074C (size: 0x4)
    char padding_1[0xC];                                                              // 0x0750 (size: 0xC)
    ...
    char padding_2[0x4];                                                              // 0x076C (size: 0x4)
...
{
    char padding_0[0x730];                                                            // 0x0000 (size: 0x0)
