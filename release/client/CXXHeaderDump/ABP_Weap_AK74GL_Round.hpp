#ifndef UE4SS_SDK_ABP_Weap_AK74GL_Round_HPP
#define UE4SS_SDK_ABP_Weap_AK74GL_Round_HPP

class UABP_Weap_AK74GL_Round_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_Weap_AK74GL_Round(int32 EntryPoint);
}; // Size: 0x2D8
