...
class UMediaPlayer : public UObject
{
    ...
    char padding_2[0x4];                                                              // 0x00D4 (size: 0x4)
    ...
    char padding_3[0x2C];                                                             // 0x00F4 (size: 0x2C)
...
class UMediaTexture : public UTexture
{
    ...
    bool EnableGenMips;                                                               // 0x00CC (size: 0x1)
    uint8 NumMips;                                                                    // 0x00CD (size: 0x1)
    char padding_1[0x2];                                                              // 0x00CE (size: 0x2)
