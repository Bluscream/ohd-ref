enum class EAmmoClipReloadBehavior {
    DiscardOnEmpty = 0,
    DiscardOnReload = 1,
    NoDiscard = 2,
...
enum class EDFCharacterCustomMovementMode {
    None = 0,
    Vaulting = 1,
    MAX = 2,
};

enum class EDFItemEnabledMode {
    Enabled = 0,
    Disabled = 1,
    Hidden = 2,
...
enum class EDFPlayerWhitelistType {
    None = 0,
    Manual = 1,
    Token = 2,
...
enum class ESessionSearchPresenceType {
    AllServers = 0,
    ListenServersOnly = 1,
