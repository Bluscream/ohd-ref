...
struct FAnimationStateEntry
{
    ...
    char padding_1[0x2];                                                              // 0x001A (size: 0x2)
    ...
    char padding_2[0x1];                                                              // 0x0023 (size: 0x1)
