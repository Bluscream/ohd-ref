...
class UVehicleWheel : public UObject
{
    ...
    char padding_4[0x4];                                                              // 0x00B0 (size: 0x4)
...
class UWheeledVehicleMovementComponent : public UPawnMovementComponent
{
    ...
    char padding_0[0x3];                                                              // 0x0141 (size: 0x3)
    uint8 bWasAvoidanceUpdated;                                                       // 0x0144 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0145 (size: 0x3)
    float Mass;                                                                       // 0x0148 (size: 0x4)
    char padding_2[0x4];                                                              // 0x014C (size: 0x4)
    ...
    char padding_3[0x4];                                                              // 0x01A4 (size: 0x4)
    TArray<class UVehicleWheel*> Wheels;                                              // 0x01A8 (size: 0x10)
    char padding_4[0x18];                                                             // 0x01B8 (size: 0x18)
    ...
    char padding_5[0x4];                                                              // 0x0218 (size: 0x4)
    ...
    char padding_6[0x24];                                                             // 0x0264 (size: 0x24)
