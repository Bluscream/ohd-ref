...
struct FAIStimulus
{
    ...
    char padding_0[0xC];                                                              // 0x002C (size: 0xC)
...
struct FBTDecoratorLogic
{
    ...
    char padding_0[0x1];                                                              // 0x0001 (size: 0x1)
...
struct FEnvQueryResult
{
    ...
    char padding_0[0x14];                                                             // 0x0018 (size: 0x14)
...
{
    char padding_0[0x328];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x328
...
class AEQSTestingPawn : public ACharacter
{
    ...
    char padding_0[0x3];                                                              // 0x04F1 (size: 0x3)
    ...
    char padding_1[0x3];                                                              // 0x04F5 (size: 0x3)
    TEnumAsByte<EEnvQueryRunMode::Type> QueryingMode;                                 // 0x04F8 (size: 0x1)
    char padding_2[0x7];                                                              // 0x04F9 (size: 0x7)
...
class UAIPerceptionComponent : public UActorComponent
{
    ...
    char padding_0[0x10];                                                             // 0x00C8 (size: 0x10)
    class AAIController* AIOwner;                                                     // 0x00D8 (size: 0x8)
    char padding_1[0x80];                                                             // 0x00E0 (size: 0x80)
...
class UAIPerceptionStimuliSourceComponent : public UActorComponent
{
    ...
    char padding_0[0x7];                                                              // 0x00B1 (size: 0x7)
...
class UAISense_Sight : public UAISense
{
    ...
    char padding_0[0x4];                                                              // 0x015C (size: 0x4)
...
class UAISystem : public UAISystemBase
{
    ...
    TEnumAsByte<ECollisionChannel> DefaultSightCollisionChannel;                      // 0x009B (size: 0x1)
...
class UBTCompositeNode : public UBTNode
{
    ...
    char padding_0[0x10];                                                             // 0x0078 (size: 0x10)
...
class UBTDecorator_BlueprintBase : public UBTDecorator
{
    ...
    char padding_0[0x10];                                                             // 0x0088 (size: 0x10)
...
class UBTDecorator_IsAtLocation : public UBTDecorator_BlackboardBase
{
    ...
    char padding_0[0x4];                                                              // 0x0094 (size: 0x4)
    ...
    char padding_1[0x3];                                                              // 0x00D1 (size: 0x3)
...
class UBTDecorator_Loop : public UBTDecorator
{
    ...
    char padding_0[0x3];                                                              // 0x006D (size: 0x3)
...
class UBTService_BlueprintBase : public UBTService
{
    ...
    char padding_0[0x10];                                                             // 0x0080 (size: 0x10)
...
class UBTTask_RunEQSQuery : public UBTTask_BlackboardBase
{
    ...
    char padding_1[0x7];                                                              // 0x00F1 (size: 0x7)
...
class UBTTask_SetTagCooldown : public UBTTaskNode
{
    ...
    char padding_0[0x3];                                                              // 0x0079 (size: 0x3)
...
class UBehaviorTreeComponent : public UBrainComponent
{
    ...
    char padding_0[0x128];                                                            // 0x0140 (size: 0x128)
    class UBehaviorTree* DefaultBehaviorTreeAsset;                                    // 0x0268 (size: 0x8)
...
class UBlackboardComponent : public UActorComponent
{
    ...
    char padding_0[0x20];                                                             // 0x00C8 (size: 0x20)
...
class UEnvQueryGenerator_OnCircle : public UEnvQueryGenerator_ProjectedPoints
{
    ...
    char padding_0[0x7];                                                              // 0x0129 (size: 0x7)
    ...
    char padding_2[0x7];                                                              // 0x0199 (size: 0x7)
...
{
    int32 QueryID;                                                                    // 0x0030 (size: 0x4)
    char padding_0[0x24];                                                             // 0x0034 (size: 0x24)
...
class UEnvQueryManager : public UAISubsystem
{
    ...
    char padding_0[0x54];                                                             // 0x00D8 (size: 0x54)
...
class UEnvQueryTest : public UEnvQueryNode
{
    ...
    char padding_1[0x5];                                                              // 0x004B (size: 0x5)
    ...
    char padding_2[0x1];                                                              // 0x00F8 (size: 0x1)
    ...
    char padding_3[0x3];                                                              // 0x00FD (size: 0x3)
    ...
    char padding_4[0xF];                                                              // 0x01E1 (size: 0xF)
...
class UEnvQueryTest_Distance : public UEnvQueryTest
{
    ...
    char padding_0[0x7];                                                              // 0x01F9 (size: 0x7)
...
class UEnvQueryTest_GameplayTags : public UEnvQueryTest
{
    ...
    char padding_0[0x6];                                                              // 0x0242 (size: 0x6)
...
{
    char padding_0[0x1F8];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x1F8
...
class UPathFollowingComponent : public UActorComponent
{
    ...
    char padding_0[0x8];                                                              // 0x00F0 (size: 0x8)
...
class UPawnAction : public UObject
{
    ...
    char padding_0[0x30];                                                             // 0x0050 (size: 0x30)
...
class UPawnSensingComponent : public UActorComponent
{
    ...
    char padding_0[0xB];                                                              // 0x00C5 (size: 0xB)
