...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
    ...
    char padding_0[0x3];                                                              // 0x04A9 (size: 0x3)
...
class UBackgroundBlur : public UContentWidget
{
    ...
    char padding_0[0x1];                                                              // 0x0133 (size: 0x1)
...
class UBorder : public UContentWidget
{
    ...
    char padding_0[0x1];                                                              // 0x0123 (size: 0x1)
    ...
    char padding_1[0x4];                                                              // 0x0154 (size: 0x4)
    ...
    char padding_2[0x3];                                                              // 0x0219 (size: 0x3)
...
class UButton : public UContentWidget
{
    ...
    char padding_0[0x4];                                                              // 0x03C4 (size: 0x4)
...
class UCanvasPanelSlot : public UPanelSlot
{
    ...
    char padding_0[0x3];                                                              // 0x0061 (size: 0x3)
...
class UComboBoxString : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x0CF6 (size: 0x2)
    FSlateFontInfo Font;                                                              // 0x0CF8 (size: 0x50)
    FSlateColor ForegroundColor;                                                      // 0x0D48 (size: 0x28)
    bool bIsFocusable;                                                                // 0x0D70 (size: 0x1)
    char padding_1[0x3];                                                              // 0x0D71 (size: 0x3)
    FComboBoxStringOnGenerateWidgetEvent OnGenerateWidgetEvent;                       // 0x0D74 (size: 0x10)
    class UWidget* GenerateWidgetForString(FString Item);
    char padding_2[0x4];                                                              // 0x0D84 (size: 0x4)
    FComboBoxStringOnSelectionChanged OnSelectionChanged;                             // 0x0D88 (size: 0x10)
    void OnSelectionChangedEvent(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    FComboBoxStringOnOpening OnOpening;                                               // 0x0D98 (size: 0x10)
    void OnOpeningEvent();
...
class UDynamicEntryBoxBase : public UWidget
{
    ...
    char padding_1[0x4];                                                              // 0x0114 (size: 0x4)
    ...
    char padding_2[0x2];                                                              // 0x0132 (size: 0x2)
    int32 MaxElementSize;                                                             // 0x0134 (size: 0x4)
    char padding_3[0x10];                                                             // 0x0138 (size: 0x10)
...
class UEditableText : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x040A (size: 0x2)
    ...
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x0418 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x0419 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x041A (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x041B (size: 0x3)
    char padding_1[0x2];                                                              // 0x041E (size: 0x2)
...
class UEditableTextBox : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x09D2 (size: 0x2)
    ...
    EVirtualKeyboardTrigger VirtualKeyboardTrigger;                                   // 0x09F0 (size: 0x1)
    EVirtualKeyboardDismissAction VirtualKeyboardDismissAction;                       // 0x09F1 (size: 0x1)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x09F2 (size: 0x1)
    FShapedTextOptions ShapedTextOptions;                                             // 0x09F3 (size: 0x3)
    char padding_1[0x2];                                                              // 0x09F6 (size: 0x2)
...
class UImage : public UWidget
{
    ...
    char padding_0[0x3];                                                              // 0x01C1 (size: 0x3)
...
class UInputKeySelector : public UWidget
{
    ...
    char padding_0[0x6];                                                              // 0x06AA (size: 0x6)
...
class UListView : public UListViewBase
{
    ...
    char padding_1[0x3];                                                              // 0x02E5 (size: 0x3)
    TArray<class UObject*> ListItems;                                                 // 0x02E8 (size: 0x10)
    char padding_2[0x10];                                                             // 0x02F8 (size: 0x10)
...
class UListViewBase : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x0116 (size: 0x2)
...
class UMultiLineEditableText : public UTextLayoutWidget
{
    ...
    char padding_0[0x7];                                                              // 0x03D1 (size: 0x7)
    ...
    char padding_1[0x1];                                                              // 0x042F (size: 0x1)
...
class UMultiLineEditableTextBox : public UTextLayoutWidget
{
    ...
    char padding_0[0x4];                                                              // 0x0BC4 (size: 0x4)
...
class UProgressBar : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x02CE (size: 0x2)
...
class URetainerBox : public UContentWidget
{
    ...
    char padding_0[0x2];                                                              // 0x0122 (size: 0x2)
...
class USafeZoneSlot : public UPanelSlot
{
    ...
    char padding_1[0x2];                                                              // 0x004E (size: 0x2)
...
class UScrollBar : public UWidget
{
    ...
    char padding_0[0x1];                                                              // 0x05E3 (size: 0x1)
...
class UScrollBox : public UPanelWidget
{
    ...
    char padding_0[0x1];                                                              // 0x082B (size: 0x1)
    ...
    char padding_1[0x3];                                                              // 0x0849 (size: 0x3)
    ...
    char padding_2[0x2];                                                              // 0x0852 (size: 0x2)
...
class USlider : public UWidget
{
    ...
    char padding_2[0x3];                                                              // 0x0495 (size: 0x3)
...
class USpinBox : public UWidget
{
    ...
    char padding_2[0x4];                                                              // 0x0424 (size: 0x4)
    FSlateFontInfo Font;                                                              // 0x0428 (size: 0x50)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0478 (size: 0x1)
    char padding_3[0x3];                                                              // 0x0479 (size: 0x3)
    float MinDesiredWidth;                                                            // 0x047C (size: 0x4)
    bool ClearKeyboardFocusOnCommit;                                                  // 0x0480 (size: 0x1)
    bool SelectAllTextOnCommit;                                                       // 0x0481 (size: 0x1)
    char padding_4[0x6];                                                              // 0x0482 (size: 0x6)
    FSlateColor ForegroundColor;                                                      // 0x0488 (size: 0x28)
    FSpinBoxOnValueChanged OnValueChanged;                                            // 0x04B0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    FSpinBoxOnValueCommitted OnValueCommitted;                                        // 0x04C0 (size: 0x10)
    void OnSpinBoxValueCommittedEvent(float InValue, TEnumAsByte<ETextCommit::Type> CommitMethod);
    FSpinBoxOnBeginSliderMovement OnBeginSliderMovement;                              // 0x04D0 (size: 0x10)
    void OnSpinBoxBeginSliderMovement();
    FSpinBoxOnEndSliderMovement OnEndSliderMovement;                                  // 0x04E0 (size: 0x10)
    void OnSpinBoxValueChangedEvent(float InValue);
    uint8 bOverride_MinValue;                                                         // 0x04F0 (size: 0x1)
    uint8 bOverride_MaxValue;                                                         // 0x04F0 (size: 0x1)
    uint8 bOverride_MinSliderValue;                                                   // 0x04F0 (size: 0x1)
    uint8 bOverride_MaxSliderValue;                                                   // 0x04F0 (size: 0x1)
    char padding_5[0x3];                                                              // 0x04F1 (size: 0x3)
    float MinValue;                                                                   // 0x04F4 (size: 0x4)
    float MaxValue;                                                                   // 0x04F8 (size: 0x4)
    float MinSliderValue;                                                             // 0x04FC (size: 0x4)
    float MaxSliderValue;                                                             // 0x0500 (size: 0x4)
...
class UTextLayoutWidget : public UWidget
{
    ...
    char padding_0[0x2];                                                              // 0x010E (size: 0x2)
...
class UThrobber : public UWidget
{
    ...
    char padding_0[0x1];                                                              // 0x010F (size: 0x1)
...
class UUserWidget : public UWidget
{
    ...
    char padding_0[0xB];                                                              // 0x01B5 (size: 0xB)
    EWidgetTickFrequency TickFrequency;                                               // 0x01C0 (size: 0x1)
    char padding_1[0x7];                                                              // 0x01C1 (size: 0x7)
...
class UWidget : public UVisual
{
    ...
    char padding_1[0x27];                                                             // 0x00D1 (size: 0x27)
...
class UWidgetAnimation : public UMovieSceneSequence
{
    ...
    char padding_0[0x7];                                                              // 0x0361 (size: 0x7)
...
class UWidgetBlueprintGeneratedClass : public UBlueprintGeneratedClass
{
    ...
    uint8 bAllowTemplate;                                                             // 0x0330 (size: 0x1)
    uint8 bAllowDynamicCreation;                                                      // 0x0330 (size: 0x1)
    uint8 bValidTemplate;                                                             // 0x0330 (size: 0x1)
    uint8 bTemplateInitialized;                                                       // 0x0330 (size: 0x1)
    uint8 bCookedTemplate;                                                            // 0x0330 (size: 0x1)
    uint8 bClassRequiresNativeTick;                                                   // 0x0330 (size: 0x1)
    char padding_0[0x7];                                                              // 0x0331 (size: 0x7)
    ...
    TSoftObjectPtr<UUserWidget> TemplateAsset;                                        // 0x0368 (size: 0x28)
    class UUserWidget* Template;                                                      // 0x0390 (size: 0x8)
...
{
    EWidgetSpace Space;                                                               // 0x0430 (size: 0x1)
    EWidgetTimingPolicy TimingPolicy;                                                 // 0x0431 (size: 0x1)
    char padding_0[0x6];                                                              // 0x0432 (size: 0x6)
    TSubclassOf<class UUserWidget> WidgetClass;                                       // 0x0438 (size: 0x8)
    FIntPoint DrawSize;                                                               // 0x0440 (size: 0x8)
    bool bManuallyRedraw;                                                             // 0x0448 (size: 0x1)
    bool bRedrawRequested;                                                            // 0x0449 (size: 0x1)
    char padding_1[0x2];                                                              // 0x044A (size: 0x2)
    float RedrawTime;                                                                 // 0x044C (size: 0x4)
    char padding_2[0x8];                                                              // 0x0450 (size: 0x8)
    FIntPoint CurrentDrawSize;                                                        // 0x0458 (size: 0x8)
    bool bDrawAtDesiredSize;                                                          // 0x0460 (size: 0x1)
    char padding_3[0x3];                                                              // 0x0461 (size: 0x3)
    FVector2D Pivot;                                                                  // 0x0464 (size: 0x8)
    bool bReceiveHardwareInput;                                                       // 0x046C (size: 0x1)
    bool bWindowFocusable;                                                            // 0x046D (size: 0x1)
    EWindowVisibility WindowVisibility;                                               // 0x046E (size: 0x1)
    bool bApplyGammaCorrection;                                                       // 0x046F (size: 0x1)
    class ULocalPlayer* OwnerPlayer;                                                  // 0x0470 (size: 0x8)
    FLinearColor BackgroundColor;                                                     // 0x0478 (size: 0x10)
    FLinearColor TintColorAndOpacity;                                                 // 0x0488 (size: 0x10)
    float OpacityFromTexture;                                                         // 0x0498 (size: 0x4)
    EWidgetBlendMode BlendMode;                                                       // 0x049C (size: 0x1)
    bool bIsTwoSided;                                                                 // 0x049D (size: 0x1)
    bool TickWhenOffscreen;                                                           // 0x049E (size: 0x1)
    char padding_4[0x1];                                                              // 0x049F (size: 0x1)
    class UUserWidget* Widget;                                                        // 0x04A0 (size: 0x8)
    char padding_5[0x20];                                                             // 0x04A8 (size: 0x20)
    class UBodySetup* BodySetup;                                                      // 0x04C8 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial;                                    // 0x04D0 (size: 0x8)
    class UMaterialInterface* TranslucentMaterial_OneSided;                           // 0x04D8 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial;                                         // 0x04E0 (size: 0x8)
    class UMaterialInterface* OpaqueMaterial_OneSided;                                // 0x04E8 (size: 0x8)
    class UMaterialInterface* MaskedMaterial;                                         // 0x04F0 (size: 0x8)
    class UMaterialInterface* MaskedMaterial_OneSided;                                // 0x04F8 (size: 0x8)
    class UTextureRenderTarget2D* RenderTarget;                                       // 0x0500 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0508 (size: 0x8)
    bool bAddedToScreen;                                                              // 0x0510 (size: 0x1)
    bool bEditTimeUsable;                                                             // 0x0511 (size: 0x1)
    char padding_6[0x2];                                                              // 0x0512 (size: 0x2)
    FName SharedLayerName;                                                            // 0x0514 (size: 0x8)
    int32 LayerZOrder;                                                                // 0x051C (size: 0x4)
    EWidgetGeometryMode GeometryMode;                                                 // 0x0520 (size: 0x1)
    char padding_7[0x3];                                                              // 0x0521 (size: 0x3)
    float CylinderArcAngle;                                                           // 0x0524 (size: 0x4)
...
class UWidgetInteractionComponent : public USceneComponent
{
    ...
    char padding_0[0x10];                                                             // 0x0200 (size: 0x10)
    ...
    char padding_1[0x3];                                                              // 0x0219 (size: 0x3)
    ...
    char padding_2[0x1];                                                              // 0x0223 (size: 0x1)
    FLinearColor DebugColor;                                                          // 0x0224 (size: 0x10)
    char padding_3[0x7C];                                                             // 0x0234 (size: 0x7C)
