...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_0[0x60];                                                             // 0x00D0 (size: 0x60)
    ...
    char padding_2[0x2];                                                              // 0x0242 (size: 0x2)
    ...
    char padding_3[0xA];                                                              // 0x0246 (size: 0xA)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
    ...
    char padding_0[0x4];                                                              // 0x00C0 (size: 0x4)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
    ...
    char padding_0[0x5];                                                              // 0x0033 (size: 0x5)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
    ...
    char padding_1[0x88];                                                             // 0x0050 (size: 0x88)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_0[0xB];                                                              // 0x00D5 (size: 0xB)
    ...
    char padding_1[0x6];                                                              // 0x016A (size: 0x6)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_1[0x2];                                                              // 0x015E (size: 0x2)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
    ...
    char padding_0[0x10];                                                             // 0x0030 (size: 0x10)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
    ...
    char padding_0[0x7];                                                              // 0x0089 (size: 0x7)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
    ...
    char padding_0[0x30];                                                             // 0x00B8 (size: 0x30)
    FBoneReference EvalSpaceBone;                                                     // 0x00E8 (size: 0x10)
    FRBFParams RBFParams;                                                             // 0x00F8 (size: 0x2C)
    EPoseDriverSource DriveSource;                                                    // 0x0124 (size: 0x1)
    EPoseDriverOutput DriveOutput;                                                    // 0x0125 (size: 0x1)
    uint8 bOnlyDriveSelectedBones;                                                    // 0x0126 (size: 0x1)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
    ...
    char padding_0[0x50];                                                             // 0x0020 (size: 0x50)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_0[0x98];                                                             // 0x00D0 (size: 0x98)
    ...
    char padding_1[0x1];                                                              // 0x01BB (size: 0x1)
    ...
    char padding_2[0x3];                                                              // 0x01BD (size: 0x3)
    FSolverIterations OverrideSolverIterations;                                       // 0x01C0 (size: 0x18)
...
struct FAnimNode_RigidBody_Chaos : public FAnimNode_SkeletalControlBase
{
    ...
    FSolverIterations OverrideSolverIterations;                                       // 0x0124 (size: 0x18)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
    ...
    char padding_0[0x4];                                                              // 0x0180 (size: 0x4)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
    ...
    char padding_0[0x1];                                                              // 0x003F (size: 0x1)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_0[0x2];                                                              // 0x00EA (size: 0x2)
    ...
    char padding_1[0x4];                                                              // 0x010C (size: 0x4)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_0[0x3C];                                                             // 0x00E8 (size: 0x3C)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
    ...
    char padding_1[0x4];                                                              // 0x015C (size: 0x4)
...
struct FAnimPhysConstraintSetup
{
    ...
    char padding_1[0x1];                                                              // 0x001F (size: 0x1)
...
{
    char padding_0[0x930];                                                            // 0x0000 (size: 0x0)
}; // Size: 0x930
...
struct FBoneSocketTarget
{
    ...
    char padding_1[0xC];                                                              // 0x0014 (size: 0xC)
...
struct FIKChainLink
{
    char padding_0[0x3C];                                                             // 0x0000 (size: 0x0)
}; // Size: 0x3C
...
struct FPoseDriverTarget
{
    ...
    char padding_1[0x8];                                                              // 0x00B0 (size: 0x8)
...
struct FRBFParams
{
    ...
    ERBFFunctionType Function;                                                        // 0x000C (size: 0x1)
    ERBFDistanceMethod DistanceMethod;                                                // 0x000D (size: 0x1)
    TEnumAsByte<EBoneAxis> TwistAxis;                                                 // 0x000E (size: 0x1)
    ...
    char padding_2[0x3];                                                              // 0x0015 (size: 0x3)
